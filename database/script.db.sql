...
ALTER TABLE `aumigos`.`id_clientes` 
ADD INDEX `fk_id_clientes_id_animais_idx` (`id_animais_id_animais` ASC) VISIBLE,
DROP INDEX `fk_id_clientes_id_animais_idx` ;
;

ALTER TABLE `aumigos`.`id_animais` 
ADD INDEX `fk_id_animais_cadastro_animal1_idx` (`cadastro_animal_idcadastro_animal` ASC) VISIBLE,
DROP INDEX `fk_id_animais_cadastro_animal1_idx` ;
;

ALTER TABLE `aumigos`.`cadastro_animal` 
ADD INDEX `fk_cadastro_animal_cadastro_cliente1_idx` (`cadastro_cliente_idcadastro_cliente` ASC) VISIBLE,
DROP INDEX `fk_cadastro_animal_cadastro_cliente1_idx` ;
;

ALTER TABLE `aumigos`.`cadastro_cliente` 
ADD INDEX `fk_cadastro_cliente_id_clientes1_idx` (`id_clientes_id_clientes` ASC) VISIBLE,
DROP INDEX `fk_cadastro_cliente_id_clientes1_idx` ;
;
